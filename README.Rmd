...
- [gamlss](https://cran.r-project.org/web/packages/gamlss/index.html): Margins can be selected from a large set of parametric distribution families using general additive models for location, scale and shape (GAMLSS).
...
- ``pit``: calculate the probabililty integral transformed (PIT) values for the response given the predictor variables.
